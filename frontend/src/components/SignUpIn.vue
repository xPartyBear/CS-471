  ...
  <div>
    ...
    <PopupBox v-if="isSignIn" @close="close()">
      ...
      <p style="text-align: center">
        No account? <button type="submit" @click="toggleAccountCreation()">Sign Up</button>
      </p>
    </PopupBox>
    ...
    <PopupBox v-if="!isSignIn" @close="close()">
      ...
      <p style="text-align: center">
        Have an account? <button type="link" @click="toggleAccountCreation()">Sign In</button>
      </p>
    </PopupBox>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    async signup() {
      ...
      const { cookies } = useCookies()
      const res = await account.signup(
        this.signUp.email,
